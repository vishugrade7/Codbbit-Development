    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        <main className="flex-1 bg-muted/20 min-h-screen">
          <header className="px-4 py-8 sm:px-6 lg:px-8 flex items-center justify-between">
            <div>
           ...
           <div className="px-4 mb-8 flex items-center justify-between gap-4 sm:px-6 lg:px-8">
