...
import { LayoutDashboard, Users, FilePlus, LogOut, PanelRightOpen, Shield, LogIn, Code, User as UserIcon, Settings, MoreHorizontal, Star, Ticket, Send, BookOpen, List } from 'lucide-react';
      ...
      <SidebarContent className="p-2">
        <SidebarMenu>
          ...
          <SidebarMenuItem>
           ...
           <SidebarMenuItem>
            <Link href="/admin/navigation" passHref>
              <SidebarMenuButton tooltip="Navigation">
                <List />
